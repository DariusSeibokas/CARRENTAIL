...
{   $RegNo=$_POST['RegNo'];
	...
	$Status=$_POST['Status'];
    $Price=$_POST['Price'];
    $car->updaterecord($RegNo, $Status, $Price);
    $result =$car->allcar();
    $count=count($result);
    if ($count>0)
    {
...
<form action = "" method = "post" id = "carentry" class="form-horizontal">
    <fieldset><legend>Update a Car Record</legend>
        ...
        <div class ="form-group">
          ...
          <div class="col-sm-10">
          <input type="text" name="Price" id="Price" class="form-control"  maxlength ="5"   value = "<?php echo $Price; ?>" required pattern="[0-9.]+">
        </div></div>
		
	    <div class="buttonarea">
    		<input type="submit" value="Update Car Record" name = "Submit">
